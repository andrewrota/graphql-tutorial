...
<div id="loading-wrapper">
    <svg class="logo" viewBox="0 0 128 128" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g>
            ...
            <path class="bglIGM" x="64" y="28" fill="#fff"
            ...
            <path class="dzEKCM" id="Triangle-Bottom" stroke="#fff" stroke-width="4" d="M30 84h70"
                  stroke-linecap="round"></path>
            <path class="DYnPx" id="Triangle-Left" stroke="#fff" stroke-width="4" d="M65 26L30 87"
                  stroke-linecap="round"></path>
            <path class="hjPEAQ" id="Triangle-Right" stroke="#fff" stroke-width="4" d="M98 87L63 26"
                  stroke-linecap="round"></path>
        </g>
    </svg>
...
<script type="text/javascript">
    window.addEventListener('load', function (event) {
        ...
        GraphQLPlayground.init(root, {
            endpoint: 'http://localhost:8080/graphql.php'
        })
    })
</script>
</body>
